...
/*
 * NOTES:
 * - if setProperties is used instead of setProperty, the OConcurrentModificationException is not thrown;
 */
public class OrientTestsManualTx {
	...
	public void vertexObjectsAreInSyncWithMultipleVertexObjects() {
		...
		Assert.assertEquals("Both queries should return " + secondValue,
